...
- Project Repository: [https://github.com/markknoffler/Transformers_from_scratch](https://github.com/markknoffler/Transformers_from_scratch)
- Issues: [GitHub Issues](https://github.com/markknoffler/Transformers_from_scratch/issues)
- Discussions: [GitHub Discussions](https://github.com/markknoffler/Transformers_from_scratch/discussions)

---

**Note**: This is an educational implementation intended for learning purposes. For production use, consider using well-established libraries like Hugging Face Transformers.
